  ...
  return (
    <Card className="border-2 bg-white/80 backdrop-blur-sm shadow-lg">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Health Score */}
        <div className={`p-4 rounded-xl border-2 ${getScoreColor(healthScore)}`}>
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <Activity className="h-4 w-4" />
                <span className="text-sm font-semibold uppercase">Financial Health</span>
              </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-green-700">Available Balance</span>
              </div>
        ...
        {/* Tax Vault */}
        <div className="bg-linear-to-br from-blue-50 to-slate-50 p-4 rounded-xl border-2 border-blue-200">
          <div className="flex items-center justify-between">
            <div className="space-y-1 flex-1">
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-blue-600" />
                <span className="text-sm font-semibold text-blue-700">Tax Vault</span>
              </div>
              <p className="text-xs text-blue-600">Secured for tax obligations</p>
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button 
                            size="icon" 
                            variant="outline" 
                            className="h-10 w-10 border-2 border-blue-200 hover:border-red-300 transition-colors cursor-pointer"
                        ...
                        >
                            {isWithdrawing ? (
                                ...
                                <Lock className="h-4 w-4 text-blue-500 hover:text-red-500 transition-colors" />
                            )}
                        </Button>
                    </TooltipTrigger>
                    <TooltipContent>
